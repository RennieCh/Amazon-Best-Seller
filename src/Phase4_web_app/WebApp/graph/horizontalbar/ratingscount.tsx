...
const RatingsBarChart: React.FC = () => {
    ...
    const loadCSV = async () => {
        ...
        Papa.parse(csv, {
            ...
            complete: (results) => {
                ...
                const sortedData = parsedData.sort((a, b) => b.ratings_count - a.ratings_count);
    ...
    return (
        <div className="container mt-5 d-flex flex-column align-items-center">
            <h4 className="text-center mb-4">Top 10 Products by Ratings Count</h4>
            ...
            <div style={{ width: '90%', maxWidth: '1200px' }}>
                <ResponsiveContainer width="100%" height={700}>
                    ...
                    >
                        ...
                        />
                        <Tooltip />
                        <Bar dataKey="ratings_count" fill="#1f77b4" barSize={40} />
                    </BarChart>
                </ResponsiveContainer>
            </div>
        </div>
